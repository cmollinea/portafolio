...
function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center w-full mb-10 gap-10">
        <form
        ...
        >
          ...
          <input
            id="name"
            className="py-2 my-0 px-4 w-80  rounded-lg outline-none bg-slate-800 focus:bg-black transition-all shadow-inner shadow-black duration-300"
            type="text"
            required
          ...
          <textarea
            id="text"
            required
            className="py-2 my-0 px-4 w-80  rounded-lg outline-none bg-slate-800 focus:bg-black transition-all 
          ...
          <button
            disabled
            className=" text-slate-100 mt-4 w-full h-12 bg-slate-800 shadow-md shadow-black font-semibold text-lg rounded-lg transition duration-300 flex place-content-center items-center gap-2 "
          >
            <FaPaperPlane />
            Avaiable Soon!
          </button>
